...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Letoma web application."
  #
  #
  ...
  #
  # settings.secret_key_base= oobAcPT0JqhbVr1S8JIYriOkY-i_HsUKQVFXGBkrNuI
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("letoma.log", "w"))
  #
  #
end
